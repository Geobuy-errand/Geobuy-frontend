...
import { FaWallet, FaArrowUp, FaArrowDown, FaClock, FaMoneyBillWave } from 'react-icons/fa'
        ...
        <>
          ...
          <div className="card">
            <div className="flex justify-between items-center mb-4">
              ...
              <Link to="/errand-runner/withdrawals" className="text-primary hover:underline text-sm">
                Withdraw
              </Link>
            </div>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-text-light">
                          Errand #{earning.errandId?.errandId || earning.bookingId?.bookingId}
                        </p>
                      </div>
                    </div>
                    <div className="text-right">
                      <p className="font-semibold text-green-600">+£{earning.providerAmount?.toFixed(2) || earning.amount?.toFixed(2)}</p>
