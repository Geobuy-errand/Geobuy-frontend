      ...
      <div className="card mt-6">
        ...
        <div className="space-y-3">
          <div className="flex justify-between">
            ...
            <span className="font-medium">{errand.distance} miles</span>
          </div>
          <div className="flex justify-between">
            <span className="text-text-light">Base Fee</span>
            <span className="font-medium">£{errand.baseFee?.toFixed(2)}</span>
          </div>
          <div className="flex justify-between">
            <span className="text-text-light">
              Distance Fee ({errand.distance} × £
              {errand.distanceFeePerMile?.toFixed(2)})
            </span>
            <span className="font-medium">
              £{errand.distanceFee?.toFixed(2)}
            </span>
          </div>
          <div className="flex justify-between">
            <span className="text-text-light">Subtotal</span>
            <span className="font-medium">£{errand.subtotal?.toFixed(2)}</span>
          </div>
          {errand.isSubscribed && (
            <div className="flex justify-between text-green-600">
              <span>Subscription Discount (20%)</span>
              <span>-£{errand.discountAmount?.toFixed(2)}</span>
            </div>
          )}
          ...
          {errand.isSubscribed && (
            <p className="text-xs text-green-600 mt-1">
              🎉 You saved £{errand.discountAmount?.toFixed(2)} with your
              subscription
            </p>
          )}
        </div>
