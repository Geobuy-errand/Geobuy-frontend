...
const About = () => {
  const { setIsSignupModalOpen } = useOutletContext();
      ...
      <div className="container-custom">
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <p className="section-subtitle">
            Your time, delivered. We're on a mission to make errand-running
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-text-light mb-4">
              At GEOBUY Errands, we believe that everyone deserves to have their
              time back. Whether you're a busy professional, a senior citizen,
              or someone who just needs a helping hand, we connect you with
              trusted local providers who can get the job done.
            </p>
            <p className="text-text-light">
              Our platform is built on trust, transparency, and a commitment to
              making life easier for everyone in our community.
            </p>
          </div>
        </div>
        ...
        <div className="mt-16 bg-primary/5 rounded-2xl p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            {/* <a href="/register/customer" className="btn-primary">
              Join as Customer
            </a> */}
            <button
            ...
            {/* <a href="/become-provider" className="btn-secondary">
              Join as Provider
            </a> */}
          </div>
        </div>
