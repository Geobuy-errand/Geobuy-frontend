...
import { FaSearch, FaFilter, FaEdit, FaSave, FaTimes, FaCheck, FaEye } from 'react-icons/fa'
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-2 text-sm">
                    ...
                    <div>
                      ...
                      <span className="ml-1">{connection.location?.town || 'N/A'}</span>
                    </div>
                    <div>
                      <span className="text-text-light">Meeting:</span>
                      <span className="ml-1 capitalize">{connection.meetingType}</span>
                    </div>
                  </div>
